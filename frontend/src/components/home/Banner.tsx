...
const Banner:React.FC = () => {
  return (
    <div className='flex flex-col justify-center items-center h-screen m-auto'>
       ...
       <div>
        <p className='text-[12px] mt-12 w-1/2 m-auto text-center'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nihil, animi quam ipsa quidem modi molestiae tempore id? Libero, eligendi unde. Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptates, officia.</p>
       </div>
    </div>
  )
}
